...
from .forms import InvoiceItemFormset, InvoiceReceiptFormSet, ReceiptForm

class InvoiceListView(LoginRequiredMixin, ListView):
  model = Invoice

  def get_queryset(self):
      return Invoice.objects.filter(academicyear = self.request.current_acyear_id)
...
class InvoiceUpdateView(LoginRequiredMixin, UpdateView):
    model = Invoice
    fields = ['student', 'academicyear',
              'classgrade', 'previous_balance']
