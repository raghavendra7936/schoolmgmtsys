...
from apps.common.models import ClassGrade, ClassSection, AcademicYear
...
class Invoice(models.Model):
  ...
  classsection = models.ForeignKey(ClassSection, on_delete=models.CASCADE)
  previous_balance = models.IntegerField(default=0)
  status = models.CharField(max_length=20, choices=[(
      'active', 'Active'), ('closed', 'Closed')], default='active')

  class Meta:
    ordering = ['student', 'academicyear']
